...
zee = Person.create({:name => "Zee", :email => "zee@example.com", :password => "password"})
...
jesse = Person.create({:name => "Jesse", :email => "jesse@example.com", :password => "password"})
...
zee = Person.create({:name => "Zee", :email => "zee@example.com", :passwprd => "password"})
